...
- 🛠️ Into Linux, BSD, fonts, LLMs, and declarative systems  
- 🧪 Always experimenting — from neural networks to stateless distros  
- ✍️ Blog writer, creative dev, open-source tinkerer
...
![LLMs](https://img.shields.io/badge/LLMs-111111?style=flat&logo=openai&logoColor=white)

#### 🧰 Dev & Infra
![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white)
![Podman](https://img.shields.io/badge/Podman-89CFF0?style=flat&logo=linux&logoColor=white)
...
![UI/UX](https://img.shields.io/badge/UI/UX-000000?style=flat&logo=sketch&logoColor=white)

---

### 🚧 Projects

- **🧠 AI-Based OSINT Tool for Crime Analysis**  
  AI + ML + CNNs for digital forensics *(ongoing)*  
- **📦 Stateless Linux Distro Setup**  
  Guide to building fully ephemeral, idempotent Linux systems  
- **💬 Gemini-Based Chatbot**  
  Gemini-powered Python GUI/TUI chatbot — college mini-project
...
- 🧾 Lisp dialects and expressive programming paradigms  
